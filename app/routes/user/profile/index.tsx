...
function onUploadStarting(xhr: XMLHttpRequest, instance: Instance, file: File) {
...
function onUploadComplete(xhr: XMLHttpRequest, { store }: Instance) {
   if (xhr.status != 200) {
         ...
         <div class="container bg-white shadow-sm rounded-lg px-6 pt-4 pb-8">
            <div class="flex">
                     ...
                     <Rescope bind="user">
                        ...
                        <AsyncButton
                           onClick={async (e, { store }) => {
                              ...
                              //let user = await putUserData({ first_name: userData.first_name, last_name: userData.last_name });
                              store.set('$root.user', userData);
                           }}
                        >
                           Save
                        </AsyncButton>
               ...
               <div class="ml-20">
                  ...
                  <UploadButton
                     /* @ts-expect-error UploadButton url prop will be fixed in framework */
