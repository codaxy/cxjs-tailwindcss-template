    ...
    <cx>
        ...
        >
            ...
            <div class="border-b flex">
                <div class="flex-grow">
                    <TextField icon="search" placeholder="Search customers, invoices, ..." class="h-full w-full" inputClass="border-transparent rounded-none"
                        focused={{ bind: "search.visible", debounce: 300 }}
                        trackFocus
                        inputAttrs={{ autoComplete: "off" }}
                        value={{ bind: "search.query", debounce: 300 }}
                    />
                    <Dropdown visible-expr="{search.visible} && {search.query} && {search.results}" offset={5} placementOrder={"down-right"} arrow class="p-4 w-[600px]" matchWidth={false}>
                ...
                >
                    ...
                    <Dropdown visible-bind="nav.expand.user" dismissOnFocusOut arrow offset={5} focusable autoFocus placementOrder={"down-left"}>
                        <Menu class="m-2">
